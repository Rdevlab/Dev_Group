...
const tasks = [
  ...
  },
  {
    ...
    group: "Boxmarket",
    info: `Create a dashboard component totaly added in one folder.`,
    link: "https://s3-alpha.figma.com/hub/file/5114337615/resized/800x480/66dbf85b-1b72-4944-b901-b3e20428feb8-cover.png",
    finalLink: "",
    state: "in progress",
  },
  {
  ...
  },
  {
    ...
    title: "landing UI",
    group: "Boxmarket",
    info: `ساخت صفحه اول لندینگ پیش مارکیت با ریکت کامپوننت. همه فایل در داخل یک فایل به نام لندینگ استفاده تنظیم شود.فقط قسما هیرو دیزاین شود . `,
    link: "https://tse4.mm.bing.net/th/id/OIP.DFql_ps_0UGH4oqACQl5PQHaD5?rs=1&pid=ImgDetMain&o=7&rm=3",
    finalLink: "",
    state: "in progress",
  },
];
